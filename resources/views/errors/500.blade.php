...
<body>
    <div class="error-card">
        ...
        <div class="error-text">Terjadi kesalahan pada server. Silakan coba lagi.</div>
        <a href="{{ Auth::check() ? route('dashboard') : route('login') }}" class="btn-back"><i class="fas fa-arrow-left"></i> Kembali</a>
    </div>
</body>
</html>
