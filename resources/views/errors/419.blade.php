...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 4rem; font-weight: 800; color: #8b5cf6; line-height: 1; }
...
<body>
    <div class="error-card">
        ...
        <div class="error-text">Sesi Anda telah habis. Silakan login kembali.</div>
